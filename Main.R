...
groupFiles <- list.files("C:/Users/dkalapati/Documents/GitHub/OpenSourceProgramming")

groupFiles

groupFilesSAS <- list.files("C:/Users/dkalapati/Documents/GitHub/OpenSourceProgramming",
...
groupFilesSAS_limit <- list.files("C:/Users/dkalapati/Documents/GitHub/OpenSourceProgramming",
                                  pattern = "sas7bdat")
groupFilesSAS_limit

# second: delete the part .sasbdat
groupFilesSAS_limit <- gsub("\\..*","",list.files("C:/Users/dkalapati/Documents/GitHub/OpenSourceProgramming",
                                                  pattern = "sas7bdat"))
groupFilesSAS_limit
...
write.csv(MainTable,"C:\\Users\\dkalapati\\Documents\\GitHub\\OpenSourceProgramming\\MainTable.csv", row.names = FALSE)
...
write.csv(MarketingDatamart,"C:\\Users\\dkalapati\\Documents\\GitHub\\OpenSourceProgramming\\MarketingDatamart.csv", row.names = FALSE)
